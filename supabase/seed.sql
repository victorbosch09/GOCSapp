...
insert into public.weapons (category, name, price, mag_price_standard, mag_price_special, capacity, in_stock) values
  ('Fusiles', 'Bacon M4 URG-I', 2500, 350, 700, NULL, true),
  ('Fusiles', 'Bacon M4 SBR', 3000, 350, 700, NULL, true),
  ('Fusiles', 'MK47 16 pulgadas', 4900, 350, 700, NULL, false),
  ('Fusiles', 'MK47 10 pulgadas', 4800, 350, 700, NULL, true),
  ('Fusiles', 'MCX', 5100, 350, 700, NULL, false),
  ('Fusiles', 'SIG CSAW', 6300, 500, 1000, NULL, true),
  ('Fusiles', 'SIG CSAW UNCAG', 6700, 500, 1000, NULL, false),
  ('Fusiles', 'SIG RSAR UNCAG', 6800, 500, 1000, NULL, false),
  ('Fusiles', 'SOLGW MK1 CAR', 4600, 350, 700, NULL, false),
  ('Fusiles', 'SOLGW MK1 UNCAG', 5900, 350, 700, NULL, false),
  ('Fusiles', 'S&T MOTIV K2C2 MLOK', 4600, 350, 700, NULL, false),
  ('Fusiles', 'S&T MOTIV K2C2 SI', 4300, 350, 700, NULL, false),
  ('Fusiles', 'S&T MOTIV K2C2 MKH', 4500, 350, 700, NULL, false),
  ('Fusiles', 'FN HERSTAL ARKA', 6100, 350, 700, NULL, false),
  ('Fusiles', 'FN HERSTAL ARKA UNCAG', 6500, 350, 700, NULL, false),
  ('Fusiles', 'DDefense DDM4V7', 5800, 350, 700, NULL, false),
  ('Fusiles', 'DD DDM4V7S', 4700, 350, 700, NULL, false),
  ('Fusiles', 'DD DDM4V7 LE', 6000, 350, 700, NULL, false),
  ('Fusiles', 'LMT MK24 MRGG-A', 8500, 500, 1000, NULL, false),
  ('Fusiles', 'LMT MK24 MRGG-A UNCAG', 10400, 500, 1000, NULL, false),
  ('Tirador', 'UAR-10', 12500, 800, 1600, '12 cargadores', false),
  ('Tirador', 'Barret M82', 30000, 1500, 3000, '14 cargadores', false),
  ('Ametrallador', 'Minimi MK3', 15000, 1000, 2000, '4 cargadores', false),
  ('AT', 'M4 MAAWS', 20000, 6000, 12000, '3 municiones', false),
  ('AT', 'M72A3 LAW', 6500, NULL, NULL, 'Uso unico', false),
  ('Pistolas', 'TT Innovations JW4 Pit Viper', 1600, 80, 160, '5 cargadores', false),
  ('Pistolas', 'TT Innovations UNCAG Pit', 2000, 80, 160, NULL, false),
  ('Pistolas', 'FN Five-seveN MK3 TR', 1280, 80, 160, NULL, false),
  ('Pistolas', 'Glock 17 Gen4', 1200, 80, 160, NULL, true),
  ('Pistolas', 'Glock 17 Gen4 Mod.', 1300, 80, 160, NULL, false);

insert into public.equipment (category, name, price, in_stock) values
  ('Casco', 'REC EXFIL Ballistic Helmet', 900, false),
  ('Chaleco', 'GRS: AVS', 1600, true),
  ('Chaleco', 'GRS: JPCR', 1200, false),
  ('Chaleco', 'GRS: JJPC 2.0', 1300, true),
  ('Chaleco', 'GRS: Plateframe', 1100, false),
  ('Chaleco', 'GRS: Stranddhogg', 1500, true),
  ('Chaleco', 'GRS: PC GEN III', 1400, false),
  ('Chaleco', 'REC ARC V2 Plate Carrier', 1700, false),
  ('Mochila', 'GRS: Spawn Radio', 1500, false),
  ('Mochila', 'GRS: Tacticool Bag', 400, false),
  ('Mochila', 'GRS: FILBE', 800, true),
  ('Mochila', 'GRS: Trizip Bag', 600, false),
  ('Mochila', 'GRS: Sling Bag', 350, false),
  ('Mochila', 'GRS: Heraldry Sling Bag', 400, false),
  ('Mochila', 'GRS MAAWS Pack', 1000, false),
  ('Mochila', 'WP IIFS Large Combat Field Pack', 950, false),
  ('Mochila', 'REC FILBE Backpack', 850, false),
  ('Mochila', 'REC 6.22 Rush-12 Backpack', 550, false),
  ('Pantalón', 'GRS: CRYE', 600, true);

insert into public.accessories (category, name, price, in_stock, notes) values
  ('Mira', 'EXPS3', 350, false, NULL),
  ('Mira', 'EXPS3 G33', 600, false, NULL),
  ('Mira', 'SpecterDR 1-4x', 700, true, NULL),
  ('Mira', '3.5-10 Scope', 650, false, NULL),
  ('Mira', '4.5-14 Scope', 800, false, NULL),
  ('Mira', 'Leupold VX-5HD 1-5X24', 750, false, NULL),
  ('Mira', 'Leupold VX-5HD 2-10X42', 900, false, NULL),
  ('Mira', 'Leupold VX-5HD 3-15X44', 1100, false, NULL),
  ('Mira', 'Leupold VX-5HD 3-15X56', 1200, false, NULL),
  ('Mira', 'Leupold VX-5HD 4-20X52', 1350, false, NULL),
  ('Mira', 'S&B PM II x56', 1600, false, NULL),
  ('Mira', 'S&B PM II x50', 1500, false, NULL),
  ('Mira', 'Primary Arms SLX-1 x24', 600, false, NULL),
  ('Mira', 'Vortex Razor HD Gen III x24', 1000, false, NULL),
  ('Mira', 'Sig Sauer Tango 4 x24', 850, false, NULL),
  ('Mira', 'NightForce ATACR x24', 1100, false, NULL),
  ('Mira', 'EoTech Vudu x24', 950, false, NULL),
  ('Mira', 'Dedal-NV DHF x24', 2200, false, NULL),
  ('Mira', 'MKH XRAY x30 LPVO G2 CSRO', 1800, false, NULL),
  ('Mira', 'Vortex Xm157 Rmr BLK', 2800, false, NULL),
  ('Mira', 'Leupold HAMR 4X24', 1200, true, NULL),
  ('Mira', 'Opticas especiales para M4 MAAWS', 1200, false, NULL),
  ('Supresor', 'Supresores 5.56mm', 400, true, NULL),
  ('Supresor', 'Supresores 6.5mm', 500, false, NULL),
  ('Supresor', 'Supresores 7.62mm', 650, true, NULL),
  ('Supresor', 'Supresor especial .308 Winchester', 850, false, NULL),
  ('Modificaciones', 'Licencia para Modificar el armamento', 1500, true, 'Habilita cambio de carcasa, grips, culata, bipode, ademas de agregar accesorios.');
